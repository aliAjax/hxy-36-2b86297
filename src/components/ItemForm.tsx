...
export const ItemForm: React.FC<ItemFormProps> = ({ isOpen, onClose, onSubmit, activityId, item }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={item ? '编辑物资' : '添加新物资'} size="lg">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setFormData({ ...formData, totalStock: val, currentStock: val });
              }}
              className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-pink-400 focus:ring-2 focus:ring-pink-100 outline-none transition-all"
            />
          </div>
